...
const LocalPin = () => {
  return (
    <svg width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <path d="M9.00098 7.5C10.6578 7.5 12.001 6.15686 12.001 4.5C12.001 2.84314 10.6578 1.5 9.00098 1.5C7.34411 1.5 6.00098 2.84314 6.00098 4.5C6.00098 6.15686 7.34411 7.5 9.00098 7.5Z" stroke="white" stroke-width="1.5" stroke-linejoin="round" />
