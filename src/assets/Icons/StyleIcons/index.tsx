...
export const SubsetIcon = (props) => {
  ...
  return (
    <svg
      ...
      {...props}
    >
      <path d="M10.416 29.167V36.4587H18.7493" stroke={strokeColor} stroke-width="5" stroke-linecap="round" stroke-linejoin="round" />
      <path d="M18.75 29.167H43.75V43.7503H18.75V36.4587V29.167Z" stroke={strokeColor} stroke-width="5" fill={fillColor} stroke-linecap="round" stroke-linejoin="round" />
      <path d="M6.25 14.0622V13.0205" stroke={strokeColor} stroke-width="5" stroke-linecap="round" stroke-linejoin="round" />
      <path d="M6.25 20.8337V19.792" stroke={strokeColor} stroke-width="5" stroke-linecap="round" stroke-linejoin="round" />
      <path d="M6.25 7.29167V6.25" stroke={strokeColor} stroke-width="5" stroke-linecap="round" stroke-linejoin="round" />
      <path d="M33.334 14.0622V13.0205" stroke={strokeColor} stroke-width="5" stroke-linecap="round" stroke-linejoin="round" />
      <path d="M33.334 20.8337V19.792" stroke={strokeColor} stroke-width="5" stroke-linecap="round" stroke-linejoin="round" />
      <path d="M33.334 7.29167V6.25" stroke={strokeColor} stroke-width="5" stroke-linecap="round" stroke-linejoin="round" />
      <path d="M33.3327 20.833H32.291" stroke={strokeColor} stroke-width="5" stroke-linecap="round" stroke-linejoin="round" />
      <path d="M7.29167 20.833H6.25" stroke={strokeColor} stroke-width="5" stroke-linecap="round" stroke-linejoin="round" />
      <path d="M7.29167 6.25H6.25" stroke={strokeColor} stroke-width="5" stroke-linecap="round" stroke-linejoin="round" />
      <path d="M13.5417 6.25H12.5" stroke={strokeColor} stroke-width="5" stroke-linecap="round" stroke-linejoin="round" />
      <path d="M20.3132 6.25H19.2715" stroke={strokeColor} stroke-width="5" stroke-linecap="round" stroke-linejoin="round" />
      <path d="M20.3132 20.833H19.2715" stroke={strokeColor} stroke-width="5" stroke-linecap="round" stroke-linejoin="round" />
      <path d="M27.0827 6.25H26.041" stroke={strokeColor} stroke-width="5" stroke-linecap="round" stroke-linejoin="round" />
      <path d="M13.5417 20.833H12.5" stroke={strokeColor} stroke-width="5" stroke-linecap="round" stroke-linejoin="round" />
      <path d="M27.0827 20.833H26.041" stroke={strokeColor} stroke-width="5" stroke-linecap="round" stroke-linejoin="round" />
      <path d="M33.3327 6.25H32.291" stroke={strokeColor} stroke-width="5" stroke-linecap="round" stroke-linejoin="round" />
    </svg>
  )
};
...
export const BookIcon = (props) => {
  ...
  return (
    <svg
      ...
      {...props}
    >
      <path d="M6.25 38.5413C6.25 30.5171 6.25 11.458 6.25 11.458C6.25 8.00623 9.04822 5.20801 12.5 5.20801H37.5V32.2913C37.5 32.2913 17.9506 32.2913 12.5 32.2913C9.0625 32.2913 6.25 35.0874 6.25 38.5413Z" stroke={strokeColor} stroke-width="5" fill={fillColor} stroke-linejoin="round" />
      <path d="M37.5 32.291C37.5 32.291 13.7018 32.291 12.5 32.291C9.04822 32.291 6.25 35.0892 6.25 38.541C6.25 41.9928 9.04822 44.791 12.5 44.791H43.75V7.29102" stroke={strokeColor} stroke-width="5" stroke-linecap="round" stroke-linejoin="round" />
      <path d="M13.542 38.541H36.4587" stroke={strokeColor} stroke-width="5" stroke-linecap="round" stroke-linejoin="round" />
    </svg>
  )
};
